  ...
  return (
    <>
        ...
        <Grid id='tools' textAlign={'center'}>
          <Heading h={'fit-content'}>Tools</Heading>
          {/* <Spacer mb={'10px'}/>/ */}
          <Grid gridTemplateColumns={['repeat(1,1fr)','repeat(2,1fr)','repeat(2,1fr)','repeat(2,1fr)']} textAlign={'center'} gap={'20px'} mt={'20px'}>
            ...
            <Grid justifyContent={'center'} className='skills-card' ><Box m={'auto'}  w={['40px','60px','80px','100px']} h={['40px','60px','80px','100px']}><Image className='skills-card-img' src='https://cdn.simpleicons.org/render/ffffff' alt='render' /></Box><Text className='skills-card-name' fontSize={['small','small','normal','medium']} fontWeight={'bold '} >Render</Text></Grid>
